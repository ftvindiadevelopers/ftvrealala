  ...
  return (
    <>
      <div className="image-section">
        <img src={AllImages.faqBanner} alt="Image" />
      </div>

      <div className="container">
        <h2 className="my-5">FashionTV Privacy Policy</h2>
        <p>
          FashionTV India operates ftvrealestate .in. This page informs you of
          ...
          Information only for internal FTV ftvrealestate.in internal processes
          and improving your experience on the site. By using the site, you
        ...
        <div>
          ...
          <p>
            ...
            information consisting of Personal information and `Sensitive
            Personal Data or Information' (SPDI) ("Information") of visitors of
            the website and comply with all legal, regulatory and/or contractual
            obligations related to privacy. FashionTV has adopted the "Privacy
            by Default" principles in its approach to data privacy, i.e., the
            privacy of data and information is upheld first by default. This
            policy covers the processing, storage, and access to information as
            required under lawful and/or contractual activities with FashionTV
            or otherwise required in the normal course of business. It describes
            FashionTV's policies and procedures on the collection, usage, and
            disclosure of information provided/received by natural persons and
            meets the requirements established under: The Information Technology
            Act, 2000 - Section 43A; The Information Technology (Reasonable
            Security Practices and Procedures and Sensitive Personal
            Information) Rules, 2011.
          </p>
        </div>
        <div>
          <h2 className="my-5">Scope</h2>
          ...
          <p>
            ...
            to be identified. Personal information may consist of Full Name,
            Date of Birth, Age, Current City, Birth City, Mobile Number, Email
            ID, Social Media Handles like Facebook, Instagram, and Twitter,
            Marital Status, Passport Details, and photo images. While
            information such as date of birth in isolation may not be enough to
            identify the visitor uniquely, a combination of full name and date
            of birth may be sufficient to do so. The Personal Information will
            be used for the internal processes of the FashionTV website, such as
            the following:
          </p>
          <br />
          <ul>
          ...
          <p>
            ...
            Internet Protocol ("IP") address, browser type, browser version, and
          ...
          <ul>
            <p>
              <p>
                ...
                website, to the visitor's email address or, where the visitor
                wishes it to be sent by post, to the visitor's postal address;
              </p>
            </p>
            <p>
              <p>
                To seek the visitor's feedback or to contact the visitor in
                relation to the services offered on the FashionTV's website;
              </p>
            </p>
            <p>
        ...
        <div>
          <h2 className="my-5">Collection of Information</h2>
          <p>
            ...
            with natural persons. This may include the installation of cookies
            and the collection of other session data.
          </p>
        </div>
        <div>
          <h2 className="my-5">Cookies Policy</h2>
          <p>
            ...
            use some portions of our site. We use cookies for the following
            purposes:
          </p>
          <ul>
            <p>
              Authentication: Cookies help us determine if a user is logged in
              and then deliver the right experience and features to that unique
              user.
            </p>
            <p>
            ...
            <p>
              ...
              interested in our services and products based on the user's
              browsing history.
            </p>
            <p>
            ...
            <p>
              ...
              services are most used. This helps us to determine what to
              improve, what to remove, and what to leave the same, hence
              providing the users a better experience.
            </p>
          </ul>
        </div>
        <div>
          ...
          <p>
            ...
            visitor wants to withdraw his/her consent to provide SPDI, he/she
            may contact the Grievance Officer, the details whereof are provided
            in clause 10 of this policy
          </p>
        </div>
        <div>
          <h2 className="my-5">
        ...
        <div>
          <h2 className="my-5">Disclosure of Information</h2>
          <p>
            ...
            visitors providing such information or as required by law. However,
            FashionTV may be legally required to disclose the information in the
            following cases:
          </p>
          <ul>
            <p>
          ...
          <p>
            ...
            partners or third parties during the normal course of business for
            the purposes mentioned in this policy. In such cases, FashionTV will
            only share information related data when we are assured that:
          </p>
          <ul>
            <p>
        ...
        <div>
          <h2 className="my-5">Changes to This Privacy Policy</h2>
          <p>
            ...
            Policy at any time, and you should check this FashionTV's Privacy
            Policy page periodically. Your continued use of the service after we
            ...
            to abide and be bound by the modified Privacy Policy. If we make any
        ...
        <div className="my-5">
          ...
          <p>
            ...
            us at the following details: <br />
